<div class="table">
	<table border="1" width="100%;" class="tablebarang">
		<tr>
			...
			if(!isset($perintah)){
				$perintah = "SELECT * FROM tbbarang WHERE type='hp'";
			}
...
<tr>
	...
	<td onclick="tampildatabarang(<?php echo "'$idbarang','$namabarang','$type','$satuan','$jumlah','$hargabeli','$hargajual','$hargaresell','$kode'" ?>)"><?php echo $kode ?></td>
		</tr>
			<?php
				}
			?>
